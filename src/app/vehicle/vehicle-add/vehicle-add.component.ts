...
export class VehicleAddComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      submitAddForm(vehicleForm:any)
      {
       ...
       // console.log(this.newVehicle.vehicleId +this.newVehicle.vehicleNumber+this.newVehicle.type+this.newVehicle.category+this.newVehicle.description+this.newVehicle.location+this.newVehicle.capacity+this.newVehicle.chargesPerKM+this.newVehicle.fixedCharges);
          this.vehicleService.addVehicle(this.newVehicle)
          .subscribe((response: any) => {
            console.log(response);
           // console.log("Hello from add component" + JSON.stringify(this.newVehicle));
